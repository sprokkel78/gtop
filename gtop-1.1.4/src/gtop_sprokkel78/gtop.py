...
class MyApplication(Gtk.Application):
    ...
    def do_activate(self):
        ...
        button_traffic.set_name("button")
        ...
        button_netstat.set_name("button")
        ...
        label5_space.set_width_chars(5)
