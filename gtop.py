...
def Update_Traffic():
    ...
    while y == 0:
        ...
        while z < 5:
            ...
            if error == 1:
                en0_bytes_sent_start = 0
                en0_bytes_recv_start = 0
                en1_bytes_sent_start = 0
                en1_bytes_recv_start = 0
                en0_bytes_sent_end = 0
                en0_bytes_recv_end = 0
                en1_bytes_sent_end = 0
                en1_bytes_recv_end = 0
                e0bs = 0
                e0br = 0
                e1bs = 0
                e1br = 0
